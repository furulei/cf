...
import { validateRemoteConfigInput } from '../services/remoteConfigGuard.js';
...
export function createApp(bindings = {}) {
    ...
    app.get('/singbox', async (c) => {
        try {
            ...
            validateRemoteConfigInput(config, runtime.config);
    ...
    app.get('/xray', async (c) => {
        ...
        try {
            validateRemoteConfigInput(inputString, runtime.config);
        } catch (error) {
            return handleError(c, error, runtime.logger);
        }
